...
export default async function Sidebar() {
  ...
  return (
    <div className="w-full md:w-64 max-h-[35vh] md:max-h-none md:h-screen bg-slate-50 dark:bg-slate-900 border-b md:border-b-0 md:border-r border-slate-200 dark:border-slate-800 text-slate-900 dark:text-slate-300 flex flex-col shrink-0 overflow-y-auto transition-colors print:hidden">
      {/* Header */}
